...
bulk <- read.csv("data/jensen/processed/jensen_rau_froese_cpm", row.names = 1)
bulk_pheno <- read.csv("data/jensen/processed/jensen_rau_froese_pheno", row.names = 1)
sn_rau <- LoadH5Seurat("data/jensen/raw/b6_sn.h5seurat")
sn_tm  <- LoadH5Seurat("data/jensen/processed/tabula_muris.h5seurat")
```
\
...
\
```{r broad.cell.types AUC, echo=FALSE, fig.height=4, fig.width=7, message=FALSE, warning=FALSE, cache=T}
