...
```{r plot gene ranks, results = 'hide'}
...
```{r plot tnse, fig.cap= "Figure 2: Dimensional reduction of subsetted, raw snRNAseq datasets. B6_1 and B6_2, left and right."}
...
```{r remove ambience plots, fig.width=7, fig.height=9, results='hide', include = F}
...
```{r remove ambience visual, fig.width=10, fig.height=15, fig.cap = "Figure 3: Changes in gene expression after removal of ambient RNA, for each sample. Col1a1, fibroblasts; Pecam1, ECs; Myh6, CMs; Tnnt2, CMs; D830005E20Rik, CMs."}
...
![Figure 4: Fig1 from Zhao 2022. Their caption was, "Human TRDN-AS and mouse Trdn-as are expressed exclusively in cardiomyocytes (CMs) and enriched in nuclei...](/proj/raulab/users/brian/r_projects/bulk_decon/jensen/scripts/rmd/by_date/08152023/media/zhao2022_fig1.png)
...
doub.both.1 <- gridExtra::grid.arrange(tnse.1, doub.plot.1, doub.vln.1, ncol = 1)
doub.both.2 <- gridExtra::grid.arrange(tnse.2, doub.plot.2, doub.vln.2, ncol = 1)


```


```{r visualize doublets, fig.width=10, fig.height=8, fig.cap= "Figure 5: Doublet scores by cluster, between samples. Threshold was defined with the upper 5% of scores."}
