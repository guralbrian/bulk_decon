...
result <- calculate_stats(test, "padj", 0.05)
...
#result <- calculate_stats(test, "log2FoldChange", 0.58)
#result.low <- calculate_stats(test, "log2FoldChange", -0.58)
result <- calculate_stats(test, "log2FoldChange", 0.58)
result$sub_sublist_name <- result$sub_sublist_name |>
                     str_replace("_","-") |>
                     as.numeric()
...
ggplot(aes(x = sub_sublist_name, y = std_dev, color = sublist_name)) +
  ...
  labs(y= "Std dev of log2FC", x = "General fibroblast proportion difference")
...
ggplot(aes(x = sub_sublist_name, y = mean_value, color = sublist_name)) +
  ...
  labs(y= "Mean log 2 fold change", x = "General fibroblast proportion difference") 
...
ggplot(aes(x = sub_sublist_name, y = false_pos +0.01, color = sublist_name)) +
  ...
  labs(y= "Genes with a fold-change > 1.5", x = "General fibroblast proportion difference") 
