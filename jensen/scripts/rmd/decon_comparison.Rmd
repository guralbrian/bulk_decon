...
```{r bisque ternary , fig.width = 7, fig.height= 4, echo=FALSE, message=FALSE, warning=FALSE}
bisque.comp <- t(bisque.marker$bulk.props) |>
  as.data.frame()
bisque.comp <- bisque.comp[,c(2,4,5)]
